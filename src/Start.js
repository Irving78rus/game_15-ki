...
function Start() {
     const { setStageOfTheGame, setItemsForRender, itemsForRender, setCoordinateEmpty, coordinateEmpty, gameResult, } = useContext(Context)
     ...
     return (
          <div onClick={modalVisibileted ? () => { setmodalVisibileted(false) } : null}  >
               <div className="hello">Добро пожаловать в игру Пятнашки
                    <div className="question" onClick={() => { setmodalVisibileted(!modalVisibileted) }}>?
